<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin.Master" CodeBehind="Adminhoteldata.aspx.vb" Inherits="Takcity.Adminhoteldata" %>
    ...
    <div class="header">
         <div style="margin:50px 50px 50px 125px; padding-right:50px; padding-left: 50px; padding-top: 0px; padding-bottom: 0px;">
            <div class="text-contactview"><br /><br /><br />
                <h1 align="center">Hotel Data</h1><br />
                <asp:SqlDataSource ID="SqlDataSource1" runat="server"></asp:SqlDataSource>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource2" Height="246px" Width="1295px">
                    <Columns>
                        ...
                        <asp:ImageField DataImageUrlField="image">
                            ...
                            <HeaderStyle BackColor="#9999FF" BorderColor="#9999FF" />
                            <ItemStyle HorizontalAlign="Center" Width="10px" BorderColor="#9999FF" />
                        </asp:ImageField>
                        <asp:BoundField DataField="detail" HeaderText="detail" SortExpression="detail" >
                        <HeaderStyle BackColor="#9999FF" BorderColor="#9999FF" />
                        <ItemStyle BorderColor="#9999FF" HorizontalAlign="Center" Width="500px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="price" HeaderText="price" SortExpression="price" >
                        <HeaderStyle BackColor="#9999FF" BorderColor="#9999FF" />
                        <ItemStyle BorderColor="#9999FF" HorizontalAlign="Center" Width="150px" />
                        </asp:BoundField>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\roomlist.mdf;Integrated Security=True;Connect Timeout=30" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [Id], [name], [image], [detail], [price], [address] FROM [Roomlists]"></asp:SqlDataSource>
            </div>
        </div>
        <br /><br /><br /><br /><br /><br />
        <div class="side-nav">     
