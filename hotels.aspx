<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Travaling.Master" CodeBehind="hotels.aspx.vb" Inherits="Takcity.hotels" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server"><br /><br />
